...
const send_notification = async function (url, options) {
    ...
    if (process.env.HTTPS_PROXY) {
        ...
        axiosOptions.httpsAgent = new dist.HttpsProxyAgent(process.env.HTTPS_PROXY);
    }
    return lib_axios.post(url, options, axiosOptions);
};
...
/* harmony default export */ async function main() {
    ...
    try {
        ...
        const r = await send_notification(`${url}${bot_token}/sendMessage`, messageOptions);
        core.debug(stringify({
